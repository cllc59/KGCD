...
from modules.KGCD import Recommender
...
if __name__ == '__main__':
    ...
    for epoch in range(args.epoch):
        ...
        if epoch % 10 == 9 or epoch == 1:
            ...
            cur_best_pre_0, stopping_step, should_stop, best_epoch = early_stopping(ret['recall'][2], cur_best_pre_0,
    ...
    print('stopping at %d, recall@20:%.4f' % (epoch, ret['recall'][2]))
